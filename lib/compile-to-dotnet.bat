...
-nostdlib ^
-assembly:de.devsurf.azure.IKVM ^
...
-r:"C:\Program Files\Windows Azure SDK\v1.6\bin\runtimes\base\x64\msshrtmi.dll" ^
-platform:x64 ^
.\..\target\ikvm-for-azure-0.0.1-SNAPSHOT.jar
cp .\de.devsurf.azure.IKVM.dll .\..\target\de.devsurf.azure.IKVM.dll
pause
